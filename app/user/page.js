    ...
    return (
        <>
            ...
            <main>
                ...
                <h1 className="mb-8 pt-8 text-2xl text-lime-50 text-center">My Registered Events</h1>
                <div className="relative mx-6 my-8 py-2 flex flex-wrap justify-center gap-4 items-center md:mx-16">
                    {eventData.length <= 0 ? <div className='mx-auto'>
                        <p className="p-8 text-center text-lime-100">No events registered yet. Reload after 5-mins if you have registered and it does not show up here.</p>
